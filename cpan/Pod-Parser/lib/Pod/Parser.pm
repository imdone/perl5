...
sub parse_text {
    ...
    ##
    ## NOTE that we push our own "accumulator" at the very beginning of the id:336
...
sub parse_from_filehandle {
    ...
    ## processing. NOTE that $in_fh might be reset during this process. id:261
...
sub parse_from_file {
    ...
    ## NOTE: we need to be *very* careful when "defaulting" the output id:198
...
#           # NOTE: isn't a part of the perl distribution, IO::String id:380
...
sub _push_input_stream {
    ...
    ## an included file.
    ##
    ## NOTE: we need to be *very* careful when "defaulting" the output id:167
