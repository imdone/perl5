...
(The following example lacks proper error checking.)
 ...
 pipe(PARENT_RDR, CHILD_WTR);  # XXX: check failure? id:872
 pipe(CHILD_RDR,  PARENT_WTR); # XXX: check failure? id:725
 ...
 while (1) {
     ...
     spawn sub {
         ...
         print "Hello there, $name, it's now ",
               scalar localtime(),
               $EOL;
         exec "/usr/games/fortune"       # XXX: "wrong" line terminators id:617
